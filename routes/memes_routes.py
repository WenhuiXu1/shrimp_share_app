...
from controllers.memes_controller import index, new, create, edit, update, delete, like, comment_new, create_comment, delete_comment, upload, comment_new_2
...
memes_routes.route('/comments/<id>/new', methods={"POST"})(comment_new)
memes_routes.route('/comments/<id>/new/2', methods={"POST"})(comment_new_2)
